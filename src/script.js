...
const moonColorTexture = textureLoader.load("/moon/moon.jpg");
const moonDisplacementTexture = textureLoader.load("/moon/moonDisplacement.jpg");
...
const moon = new Mesh(new THREE.SphereGeometry(0.7, 64, 64), moonMaterial);

moon.position.set(0, 5.5, 0);

scene.add(moon);

const light = new THREE.SpotLight(0xffffff, 20, 8, Math.PI * 0.1, 0.65, 1);
...
const spotlightLightHelper = new THREE.SpotLightHelper(light, 0.2);
...
const walls = new THREE.Mesh(
  new THREE.BoxGeometry(4, 2.5, 4, 3, 3),
...
const roof = new THREE.Mesh(
  new THREE.ConeGeometry(2 * Math.sqrt(2) + 0.3, 1, 4),
...
bush1.position.set(1.5, 0.2, 2.6);

const bush2 = new THREE.Mesh(bushGeometry, bushMaterial);
bush2.scale.set(0.25, 0.25, 0.25);
bush2.position.set(2.2, 0.125, 2.3);

const bush3 = new THREE.Mesh(bushGeometry, bushMaterial);
bush3.scale.set(0.4, 0.4, 0.4);
bush3.position.set(-1.4, 0.1, 2.5);

const bush4 = new THREE.Mesh(bushGeometry, bushMaterial);
bush4.scale.set(0.15, 0.15, 0.15);
bush4.position.set(-2, 0.05, 2.4);
...
const graveMaterial = new THREE.MeshStandardMaterial({ color: "#aaa7a7" });
